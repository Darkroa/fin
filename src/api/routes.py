...
The complete route implementation is vendored here so production startup does not depend on Git history.
"""
...
import random, string, base64, io, os, re, json, hmac, hashlib, time, uuid, asyncio
import httpx
